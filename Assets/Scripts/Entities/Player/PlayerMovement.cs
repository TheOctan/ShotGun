...
public class PlayerMovement : MonoBehaviour
{
	...
	{
        Vector3 targetDirection = alignToCamera ? AlignToCamera(movementDirection) : movementDirection;
        Vector3 movement = targetDirection * movementSpeed * Time.fixedDeltaTime;
	...
	private void RotateTowards(Vector3 direction)
	{
		...
		{
			Quaternion targetRotation = Quaternion.LookRotation(alignToCamera ? AlignToCamera(direction) : direction);
